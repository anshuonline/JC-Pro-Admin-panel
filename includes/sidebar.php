...
<aside class="w-64 bg-white/60 backdrop-blur-2xl border-r border-slate-200/60 hidden md:flex md:flex-col shadow-[4px_0_24px_rgb(0,0,0,0.02)] z-20 transition-transform duration-300" id="sidebar">
    ...
    <div class="overflow-y-auto overflow-x-hidden flex-grow py-6">
        ...
        <nav class="space-y-1.5 px-3">
            ...
            <a href="manage_updates.php" class="<?php echo $currentPage == 'manage_updates.php' ? 'bg-orange-50 text-orange-700 shadow-sm border border-orange-200' : 'text-slate-600 hover:bg-slate-100/80 hover:text-slate-900 border border-transparent'; ?> group flex items-center px-3 py-2.5 text-sm font-semibold rounded-xl transition-all duration-200">
                <i class="fa-solid fa-download mr-3 w-5 text-center <?php echo $currentPage == 'manage_updates.php' ? 'text-orange-600' : 'text-slate-400 group-hover:text-orange-600'; ?>"></i>
                App Updates
            </a>
            ...
            <a href="admin_logs.php" class="<?php echo $currentPage == 'admin_logs.php' ? 'bg-orange-50 text-orange-700 shadow-sm border border-orange-200' : 'text-slate-600 hover:bg-slate-100/80 hover:text-slate-900 border border-transparent'; ?> group flex items-center px-3 py-2.5 text-sm font-semibold rounded-xl transition-all duration-200">
                <i class="fa-solid fa-clipboard-list mr-3 w-5 text-center <?php echo $currentPage == 'admin_logs.php' ? 'text-orange-600' : 'text-slate-400 group-hover:text-orange-600'; ?>"></i>
                Admin Logs
            </a>
        </nav>
