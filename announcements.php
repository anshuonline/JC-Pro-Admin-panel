...
<head>
    ...
    <title>System Status - JC Pro Admin</title>
...
<body class="text-slate-800 antialiased selection:bg-orange-200 selection:text-orange-900 flex h-screen overflow-hidden">

    <?php include 'includes/sidebar.php'; ?>

    <main class="flex-1 flex flex-col h-screen overflow-hidden relative w-full md:w-auto">
                        ...
                        <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 sticky top-6">
                            ...
                            <form method="POST" id="announcementForm">
                                ...
                                <div class="mb-6">
                                    ...
                                    <textarea name="message" id="messageInput" rows="4" class="w-full px-4 py-2.5 rounded-xl border border-slate-200 focus:border-orange-500 focus:ring-2 focus:ring-orange-200 outline-none transition-all resize-none" placeholder="Enter details..." required></textarea>
                                </div>
